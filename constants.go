...
var gIntFacts = []sCustomPrompt{
	...
	},
	{
		...
		Prompt: [][]openai.ChatCompletionMessage{
			...
			{
				{Role: openai.ChatMessageRoleUser, Content: "Открой сайт bbc и дай развернутый комментарий к наиболее интересной новости. Начни с фразы типа 'Новости подкатили!' и отступи строку."},
				...
				{Role: openai.ChatMessageRoleUser, Content: "Открой сайт rbc.ru и дай развернутый комментарий к наиболее интересной новости. Начни с фразы типа 'Считаем денежки!' и отступи строку."},
