	...
	},
	{
		...
		Prompt: [][]openai.ChatCompletionMessage{
			...
			},
			{
				...
				{Role: openai.ChatMessageRoleUser, Content: "Придумай необычную социальную проблему, прокомментируй, предложи решение. Начни с фразы типа 'О наболевшем!' и отступи строку."},
				...
				{Role: openai.ChatMessageRoleUser, Content: "Поразмышляй о мировой экономике. Начни с фразы типа 'Считаем денежки!' и отступи строку."},
