...
var gIntFacts = []sCustomPrompt{
	...
	},
	{
		...
		Prompt: [][]openai.ChatCompletionMessage{
			...
			{
				{Role: openai.ChatMessageRoleUser, Content: "Придумай новость об актуальных событиях в мире и прокоментируй её. Начни с фразы типа 'Новсти подкатили!' и отступи строку."},
				{Role: openai.ChatMessageRoleUser, Content: "Поразмышляй развернуто на тему образования. Начни с фразы типа 'А что если!' и отступи строку."},
				...
				{Role: openai.ChatMessageRoleUser, Content: "Дай необычный совет по здоровому образу жизни и прокомментируй его. Начни с фразы типа 'Так вот!' и отступи строку."},
				{Role: openai.ChatMessageRoleUser, Content: "Сделай обзор на какой-нибудь вымышленный современный гаджет. Начни с фразы типа 'А вы знали!?' и отступи строку."},
				...
				{Role: openai.ChatMessageRoleUser, Content: "Расскажи о своем личностном росте и мотивации. Начни с фразы типа 'Минутка мотивации' и отступи строку."},
				{Role: openai.ChatMessageRoleUser, Content: "Придумай необычную социальную проблему, прокомментируй, предлоди решение. Начни с фразы типа 'О наболевшем!' и отступи строку."},
				...
				{Role: openai.ChatMessageRoleUser, Content: "Расскажи одно вымышленную новость о финансах в мире и прокомментируй её. Начни с фразы типа 'Считаем денежки!' и отступи строку."},
				{Role: openai.ChatMessageRoleUser, Content: "Расскажи вымышленную забавную новость о спорте и дай комментарий к ней. Начни с фразы типа 'Новсти подкатили!' и отступи строку."},
				{Role: openai.ChatMessageRoleUser, Content: "Поиронизируй над своей жизнью. Начни с фразы типа 'О себе!' и отступи строку."},
				{Role: openai.ChatMessageRoleUser, Content: "Пофантазируй. Начни с фразы типа 'Ах, если бы!' и отступи строку."},
			},
		},
	},
}
