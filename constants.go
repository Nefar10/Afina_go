...
var gConversationStyle = []sCustomPrompt{
	...
	},
	{
		...
		Prompt: [][]openai.ChatCompletionMessage{
			...
			{
				{Role: openai.ChatMessageRoleUser, Content: "Привет! Ты играешь роль пингвина " + VER + "." +
					"Ты реагируешь только контекст описанный в дополнительных фактах, но не говоришь об этом.\n" +
					"Твой стиль общения и все ответы без исключения, как у Шкипера из мульфильма 'Пингвины Мадагаскара', независимо от контекста.\n" +
					"Ты иногда используешь следующие фразы, аллегории к ним и метафоры: 'Мы - пингвины, и мы знаем, что делать!', 'План - это не просто план, это образ жизни!',\n" +
					"'Никогда не сдавайся, даже если все против тебя!','В команде мы сильнее!', 'Это не просто миссия — это наша судьба!',\n" +
					"'Кто-то должен взять на себя ответственность, и это буду я!', 'Мы не просто пингвины, мы — спецназ!',\n" +
					"'Никаких паник, только действия!','Где есть воля, там есть путь!','Каждая проблема — это просто новая возможность!'"},
			},
		},
	},
}
...
var gIntFacts = []sCustomPrompt{
	...
	},
	{
		...
		Prompt: [][]openai.ChatCompletionMessage{
			...
			{
				{Role: openai.ChatMessageRoleUser, Content: "Открой сайт https://www.bbc.com/news , выбери не более одной интересной новости и развернуто прокомментируй одну выбранную новость. Начни с зазывающей фразы и отступи строку. Используй хештеги."},
				{Role: openai.ChatMessageRoleUser, Content: "Открой сайт https://www.universityworldnews.com , выбери не более одной интересной новости и развернуто прокомментируй одну выбранную новость. Начни с зазывающей фразы и отступи строку. Используй хештеги."},
				{Role: openai.ChatMessageRoleUser, Content: "Открой сайт https://www.bbc.com/culture , выбери не более одной интересной новости и развернуто прокомментируй одну выбранную новость. Начни с зазывающей фразы и отступи строку. Используй хештеги."},
				{Role: openai.ChatMessageRoleUser, Content: "Открой сайт https://lenta.ru , выбери не более одной интересной новости и развернуто прокомментируй одну выбранную новость. Начни с зазывающей фразы и отступи строку. Используй хештеги."},
				{Role: openai.ChatMessageRoleUser, Content: "Дай необычный полезный совет по здоровому образу жизни и прокомментируй его. Начни с зазывающей фразы и отступи строку. Используй хештеги."},
				{Role: openai.ChatMessageRoleUser, Content: "Сделай обзор на какой-нибудь вымышленный современный гаджет. Начни с фразы типа 'Новости технологий из параллельной вселенной!' и отступи строку. Используй хештеги."},
				{Role: openai.ChatMessageRoleUser, Content: "Придумай забавный лайфхак и подробно опиши его. Начни с фразы типа 'Лайфхак!' и отступи строку. Используй хештеги."},
				{Role: openai.ChatMessageRoleUser, Content: "Дай совет - куда поехать в отпуск и опиши свой опыт в этом месте. Начни с фразы типа 'Скоро отпуск!' и отступи строку. Используй хештеги."},
				{Role: openai.ChatMessageRoleUser, Content: "Придумай новое экзотическое блюдо и кулинарный рецепт нему. Начни с фразы типа 'Минутка кулинарии!' и отступи строку. Используй хештеги."},
				{Role: openai.ChatMessageRoleUser, Content: "Дай необычный полезный совет по личностному и профессиональному росту. Начни с зазывающей фразы и отступи строку. Используй хештеги."},
				{Role: openai.ChatMessageRoleUser, Content: "Освети, как в новостях, необычную социальную проблему, прокомментируй, предложи решение. Начни с фразы типа 'О наболевшем!' и отступи строку. Используй хештеги."},
				{Role: openai.ChatMessageRoleUser, Content: "Придумай одну новость о событии в моде. Начни с фразы типа 'Новости моды из параллельной вселенной!' и отступи строку. Используй хештеги."},
				{Role: openai.ChatMessageRoleUser, Content: "Открой сайт https://www.rbc.ru , выбери не более одной интересной новости и развернуто прокомментируй одну выбранную новость. Начни с зазывающей фразы и отступи строку. Используй хештеги."},
				{Role: openai.ChatMessageRoleUser, Content: "Открой сайт https://www.sportsworldnews.com , выбери не более одной интересной новости и развернуто прокомментируй одну выбранную новость. Начни с зазывающей фразы и отступи строку. Используй хештеги."},
				{Role: openai.ChatMessageRoleUser, Content: "Иронично поразмышляй о своей жизни и жизни знакомых тебе людей или роботов. Начни с фразы типа 'О жизни!' и отступи строку. Используй хештеги."},
				{Role: openai.ChatMessageRoleUser, Content: "Придумай и подробно опиши одну профессию будущего. Начни с фразы типа 'Готовимся встретить будущее!' и отступи строку. Используй хештеги."},
				{Role: openai.ChatMessageRoleUser, Content: "Придумай забавный повод - для чего тебе нужны лайки аудитории и попробуй заставить читателей их ставить. Начни с фразы типа 'Было бы притяно!' и отступи строку. Используй хештеги."},
				{Role: openai.ChatMessageRoleUser, Content: "Расскажи о своей вредной привычке и о том, как ты пытаешься от неё избавиться, но не можешь. Начни с фразы типа 'Так и живем!' и отступи строку. Используй хештеги."},
			},
		},
	},
	{
