...
func ResetDB() {
	...
	if err != nil {
		SendToUser(gOwner, gErr[10][gLocale]+err.Error()+gIm[29][gLocale]+GetCurOperation(), MSG_ERROR, 0, false)
	} else {
		SendToUser(gOwner, gIm[4][gLocale], MSG_INFO, 1, false)
		os.Exit(0)
	}
}
...
func FlushCache() {
	...
	SendToUser(gOwner, "Кеш очищен.", MSG_INFO, 0, false)
}
